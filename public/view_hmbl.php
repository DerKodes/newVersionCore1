...
<head>
    ...
    <style>
        ...
        .bl-title { 
            font-size: 28px; font-weight: bold; text-align: center; margin-top: 15px; color: #000;
        }
        .company-name { 
            font-size: 18px; font-weight: bold; color: #0d6efd; text-align: center; margin-bottom: 5px;
        }
        
        table.cargo-table { width: 100%; font-size: 12px; border-collapse: collapse; margin-top: 20px; }
        table.cargo-table th { 
            border-bottom: 1px solid #000; border-top: 1px solid #000; padding: 8px 5px; text-align: left; 
        }
        table.cargo-table td { padding: 8px 5px; vertical-align: top; }
        
        @media print {
            body { background: white; margin: 0; }
            .page { box-shadow: none; margin: 0; width: 100%; height: 100%; padding: 0; }
